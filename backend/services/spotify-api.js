...
export async function getUserPlaylists(accessToken, { limit, offset }) {
  return spotifyGet('/me/playlists', accessToken, { limit, offset })
}
...
export async function getUserSavedTracks(
  ...
  return spotifyGet('/me/tracks', accessToken, { limit, offset, market })
}

export async function getUserSavedAlbums(accessToken, { limit, offset, market }) {
  return spotifyGet('/me/albums', accessToken, { limit, offset, market })
}

export async function getPlaylist(accessToken, playlistId, { market }) {
  return spotifyGet(`/playlists/${playlistId}`, accessToken, { market })
}
...
export async function searchSpotify(
  ...
  return spotifyGet('/search', accessToken, {
    q,
    type,
    limit,
    offset,
...
export async function getTrack(accessToken, trackId, { market }) {
  return spotifyGet(`/tracks/${trackId}`, accessToken, { market })
}

export async function getAlbum(accessToken, albumId, { market }) {
  return spotifyGet(`/albums/${albumId}`, accessToken, { market })
}
...
export async function getArtistTopTracks(accessToken, artistId, { market }) {
  return spotifyGet(`/artists/${artistId}/top-tracks`, accessToken, { market })
}
...
export async function getFeaturedPlaylists(
  ...
  return spotifyGet('/browse/featured-playlists', accessToken, {
    country,
    locale,
    timestamp,
    limit,
...
export async function getCategories(
  ...
  return spotifyGet('/browse/categories', accessToken, {
    country,
    locale,
    limit,
    offset,
...
export async function getNewReleases(accessToken, { country, limit, offset }) {
  return spotifyGet('/browse/new-releases', accessToken, {
    country,
    limit,
    offset,
  })
...
export async function getAvailableGenreSeeds(accessToken) {
  return spotifyGet('/recommendations/available-genre-seeds', accessToken)
}
...
export async function getRecommendations(
  ...
  return spotifyGet('/recommendations', accessToken, {
    seed_artists,
    seed_tracks,
    seed_genres,
    limit,
...
export async function getUserTopItems(
  ...
  return spotifyGet(`/me/top/${type}`, accessToken, {
    time_range,
    limit,
    offset,
  })
